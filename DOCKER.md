...
This guide explains how to run the CheckDot Lending Backend using Docker.
...
```bash
docker-compose exec mongodb mongosh checkdot-lending
```
...
- `MONGODB_URI`: MongoDB connection string (default: mongodb://mongodb:27017/checkdot-lending)
